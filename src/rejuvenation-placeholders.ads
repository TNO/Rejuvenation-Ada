...
package Rejuvenation.Placeholders is
   ...
   function Is_Placeholder (Node : Ada_Node'Class) return Boolean with
   ...
   --  TODO: should we promise the nodes appear in their textual order?
   ...
   --  When the provided Node is null, the empty set will be returned.
